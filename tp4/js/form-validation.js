...
*/
    //form ou document
    const form = document.getElementById('form'); // Sélectionne directement l'élément <form>
    form.addEventListener('submit', valider);
    /*l'evenenment du clique du boutton GPS, on a utilisé function sans préciser le nom de 
    la fonction car on pourra appeler plusieurs fonctions dans le meme bout de code*/
...
function valider(e) {
    ...
    const addresstxt = document.getElementById('address').value;
    // Récupérez l'élément du titre et body du modal
    ...
    const errmodal_id = document.getElementById('myModal');
    // Vérification de la dte de naissance
    const birthdayDate = new Date(date_naissancetxt);
    const birthdayTimestamp = birthdayDate.getTime();
    const nowTimestamp = Date.now();
    //déclarer les messags d'erreurs
    /* var erraddress = "";
     var errcodep = "";
     var errregion = "";*/
    var messagerr = "";
    ...
    var ErreurGlobal = "";
    var total = "";
    //Tous les champs sont obligatoires. Veuillez remplir tous les champs du formulaire.
    if (nametxt === "" && firstnametxt === "" && addresstxt === "" && codepostaltxt === "" && mailtxt === "" && date_naissancetxt === "" && regiontxt === "") {
        ...
        //modalTitle.textContent = "Erreur dans le formulaire.\n"; // Définissez le contenu du titre
        ErreurGlobal = "Tous les champs sont obligatoires.\n Veuillez remplir tous les champs du formulaire.";
        ...
        */
        ...
        if (total !== "") {
            ...
            /*// Construire le message à afficher dans le modal
            ...
            modalValidBody.textContent = "vous etes né.é le " + date_naissancetxt;
